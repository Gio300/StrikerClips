 ...
 *
 * This is a draft template pending review by legal counsel.
 */
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 sm:p-8 text-gray-300 space-y-4">
      ...
      <div className="rounded-lg border border-kunai/40 bg-kunai/10 p-4 text-sm text-gray-200">
        <strong className="text-white">Draft template — pending review by legal counsel.</strong> This page
        explains how to delete your {BRAND.name} account and request your data. It is not legal advice and
        should be finalized by qualified counsel before launch.
      </div>
      ...
      <p className="text-xs text-gray-500">
        This is a draft template and not legal advice. It should be reviewed and finalized by qualified legal
